document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateVbusPath(data) {
        ...
        // 2. قرمز (رفت)
            ...
            if (d.VBUS_OVP_STAT) {
                ...
                if ((d.AC1_PRESENT_STAT == 1 && d.AC2_PRESENT_STAT == 1) && ((d.VBAT_PRESENT_STAT == 1 && (d.VSYS_ADC_15_0 - d.VBAT_ADC_15_0 - 50 > 0) || ((d.VINDPM_STAT == 1 || d.IINDPM_STAT == 1 || d.IBAT_REG_STAT == 1 || d.TREG_STAT == 1) && d.VSYS_ADC_15_0 - d.VBAT_ADC_15_0 - 50 <= 0)) || (d.VBAT_PRESENT_STAT == 0 && (d.VSYS_ADC_15_0 >= d.VSYSMIN_5_0 || ((d.VINDPM_STAT == 1 || d.IINDPM_STAT == 1 || d.IBAT_REG_STAT == 1 || d.TREG_STAT == 1) && d.VSYS_ADC_15_0 < d.VSYSMIN_5_0))))) {
                    vbusPathOverallStatus = { text: "به علت خطای اظافه ولتاژ ورودی از آداپتور کمکی استفاده میشود.", colorClass: "status-bg-error" };
                }
            }
                ...
                if (d.EN_IBUS_OCP == 1) {
                    ...
                    vbusPathOverallStatus = { text: "آداپتور حضور دارد خطای جریان کشی بیش از حد از ورودی رخ داده، اما مبدل روشن است.", colorClass: "status-bg-error" };
                }

                if ((d.AC1_PRESENT_STAT == 1 && d.AC2_PRESENT_STAT == 1) && ((d.VBAT_PRESENT_STAT == 1 && (d.VSYS_ADC_15_0 - d.VBAT_ADC_15_0 - 50 > 0) || ((d.VINDPM_STAT == 1 || d.IINDPM_STAT == 1 || d.IBAT_REG_STAT == 1 || d.TREG_STAT == 1) && d.VSYS_ADC_15_0 - d.VBAT_ADC_15_0 - 50 <= 0)) || (d.VBAT_PRESENT_STAT == 0 && (d.VSYS_ADC_15_0 >= d.VSYSMIN_5_0 || ((d.VINDPM_STAT == 1 || d.IINDPM_STAT == 1 || d.IBAT_REG_STAT == 1 || d.TREG_STAT == 1) && d.VSYS_ADC_15_0 < d.VSYSMIN_5_0))))) {
                    vbusPathOverallStatus = { text: "به علت خطای اظافه جریان ورودی از آداپتور کمکی استفاده میشود.", colorClass: "status-bg-error" };
                }
            }
                ...
                if ((d.AC1_PRESENT_STAT == 1 && d.AC2_PRESENT_STAT == 1) && ((d.VBAT_PRESENT_STAT == 1 && (d.VSYS_ADC_15_0 - d.VBAT_ADC_15_0 - 50 > 0) || ((d.VINDPM_STAT == 1 || d.IINDPM_STAT == 1 || d.IBAT_REG_STAT == 1 || d.TREG_STAT == 1) && d.VSYS_ADC_15_0 - d.VBAT_ADC_15_0 - 50 <= 0)) || (d.VBAT_PRESENT_STAT == 0 && (d.VSYS_ADC_15_0 >= d.VSYSMIN_5_0 || ((d.VINDPM_STAT == 1 || d.IINDPM_STAT == 1 || d.IBAT_REG_STAT == 1 || d.TREG_STAT == 1) && d.VSYS_ADC_15_0 < d.VSYSMIN_5_0))))) {
                    vbusPathOverallStatus = { text: "به علت اضافه ولتاژ در جفت ماسفت ها از آداپتور کمکی استفاده میشود.", colorClass: "status-bg-error" };
                }
            }
            else if (d.PG_STAT == 0) {
        ...
        // 5. صورتی (رفت و برگشت)
        else if (!(d.VBUS_OVP_STAT == 1 || d.VSYS_OVP_STAT == 1 || d.VBAT_OVP_STAT == 1 || d.TSHUT_STAT == 1 || d.OTG_OVP_STAT == 1 || d.OTG_UVP_STAT == 1 || (d.EN_OTG == 1 && (d.TS_COLD_STAT == 1 || d.TS_HOT_STAT == 1)) || d.EN_HIZ == 1 || d.SDRV_CTRL != 0 || d.VAC_OVP_STAT == 1 || d.VSYS_SHORT_STAT == 1) && d.TS_COLD_STAT == 0 && d.TS_HOT_STAT == 0 && d.OTG_OVP_STAT == 0 && d.OTG_UVP_STAT == 0 && d.VBATOTG_LOW_STAT == 0 && ((d.ACRB1_STAT == 1 || d.ACRB2_STAT == 1) && (d.EN_ACDRV1 == 0 && d.EN_ACDRV2 == 0)) && d.CHG_STAT_2_0 == 0) {
            ...
            else if ((d.AC1_PRESENT_STAT == 1 || d.AC2_PRESENT_STAT == 1) && !(d.IBUS_OCP_STAT == 1 && d.EN_IBUS_OCP == 1)) {
        ...
        // 6. زرد (رفت)
        else if (!(d.VBUS_OVP_STAT == 1 || d.VSYS_OVP_STAT == 1 || d.VBAT_OVP_STAT == 1 || (d.IBUS_OCP_STAT == 1 && d.EN_IBUS_OCP == 1) || d.PG_STAT == 0 || d.TSHUT_STAT == 1 || d.OTG_OVP_STAT == 1 || d.OTG_UVP_STAT == 1 || (d.EN_OTG == 1 && (d.TS_COLD_STAT == 1 || d.TS_HOT_STAT == 1)) || d.EN_HIZ == 1 || d.SDRV_CTRL != 0 || d.VAC_OVP_STAT == 1 || d.VSYS_SHORT_STAT == 1) && d.VBUS_PRESENT_STAT == 1 && d.EN_OTG == 0 && ((d.ACRB1_STAT == 0 && d.ACRB2_STAT == 0) || (d.EN_ACDRV1 == 1 || d.EN_ACDRV2 == 1)) && (d.VINDPM_STAT == 1 || d.IINDPM_STAT == 1 || d.IBAT_REG_STAT == 1 || d.TREG_STAT == 1)) {
        ...
        // 7. زرد (برگشت)
        else if (!(d.VBUS_OVP_STAT == 1 || d.VSYS_OVP_STAT == 1 || d.VBAT_OVP_STAT == 1 || d.TSHUT_STAT == 1 || d.OTG_OVP_STAT == 1 || d.OTG_UVP_STAT == 1 || (d.EN_OTG == 1 && (d.TS_COLD_STAT == 1 || d.TS_HOT_STAT == 1)) || d.EN_HIZ == 1 || d.SDRV_CTRL != 0 || d.VAC_OVP_STAT == 1 || d.VSYS_SHORT_STAT == 1) && d.TS_COLD_STAT == 0 && d.TS_HOT_STAT == 0 && d.OTG_OVP_STAT == 0 && d.OTG_UVP_STAT == 0 && d.VBATOTG_LOW_STAT == 0 && d.EN_OTG == 1 && ((d.ACRB1_STAT == 0 && d.ACRB2_STAT == 0) || (d.EN_ACDRV1 == 1 || d.EN_ACDRV2 == 1)) && d.CHG_STAT_2_0 == 0 && (d.IINDPM_STAT == 1 || d.IBAT_REG_STAT == 1 || d.TREG_STAT == 1) && d.VBUS_STAT_3_0 == 7) {
        ...
        // 10. آبی (برگشت)
        else if (!(d.VBUS_OVP_STAT == 1 || d.VSYS_OVP_STAT == 1 || d.VBAT_OVP_STAT == 1 || d.TSHUT_STAT == 1 || d.OTG_OVP_STAT == 1 || d.OTG_UVP_STAT == 1 || (d.EN_OTG == 1 && (d.TS_COLD_STAT == 1 || d.TS_HOT_STAT == 1)) || d.EN_HIZ == 1 || d.SDRV_CTRL != 0 || d.VAC_OVP_STAT == 1 || d.VSYS_SHORT_STAT == 1) && d.TS_COLD_STAT == 0 && d.TS_HOT_STAT == 0 && d.OTG_OVP_STAT == 0 && d.OTG_UVP_STAT == 0 && d.VBATOTG_LOW_STAT == 0 && d.EN_OTG == 1 && ((d.ACRB1_STAT == 0 && d.ACRB2_STAT == 0) || (d.EN_ACDRV1 == 1 || d.EN_ACDRV2 == 1)) && d.CHG_STAT_2_0 == 0 && d.IINDPM_STAT == 0 && d.IBAT_REG_STAT == 0 && d.TREG_STAT == 0 && d.VBUS_STAT_3_0 == 7) {
    ...
    function updateVbatPath(data) {
        ...
        // 4. بنفش (برگشت)
        else if ((d.VBUS_PRESENT_STAT == 0 || (d.VSYS_OVP_STAT == 1 || (d.EN_OTG == 0 && (((d.ACRB1_STAT == 0 && d.ACRB2_STAT == 0) || (d.EN_ACDRV1 == 1 || d.EN_ACDRV2 == 1)) && d.PG_STAT == 0)) || d.TSHUT_STAT == 1 || d.OTG_OVP_STAT == 1 || d.OTG_UVP_STAT == 1 || d.EN_HIZ == 1 || d.VBATOTG_LOW_STAT == 1 || d.VSYS_SHORT_STAT == 1 || (d.CHG_STAT_2_0 == 0 && ((d.EN_OTG == 0 && d.VSYS_ADC_15_0 - d.VBAT_ADC_15_0 - 50 <= 0) || (d.EN_OTG == 1 && d.VBUS_ADC_15_0 < d.VOTG_10_0)) && ((d.EN_OTG == 0 && d.VINDPM_STAT == 0) || d.EN_OTG == 1) && d.IINDPM_STAT == 0 && d.IBAT_REG_STAT == 0 && d.TREG_STAT == 0) || (d.IBUS_OCP_STAT == 1 && d.EN_IBUS_OCP == 1))) || ((d.VBUS_OVP_STAT == 1 || d.VSYS_OVP_STAT == 1 || d.VBAT_OVP_STAT == 1) && ((d.AC1_PRESENT_STAT == 0 || d.AC2_PRESENT_STAT == 0) || ((d.VSYS_ADC_15_0 - d.VBAT_ADC_15_0 - 50 <= 0) && (d.VINDPM_STAT == 1 || d.IINDPM_STAT == 1 || d.IBAT_REG_STAT == 1 || d.TREG_STAT == 1)))) && d.SDRV_CTRL == 0 && d.VBATOTG_LOW_STAT == 0 && d.TS_COLD_STAT == 0 && d.TS_HOT_STAT == 0 && d.VBAT_OVP_STAT == 0 && d.IBAT_OCP_STAT == 0 && (d.EN_OTG == 0 || ((d.ACRB1_STAT == 0 && d.ACRB2_STAT == 0) || (d.EN_ACDRV1 == 1 || d.EN_ACDRV2 == 1))) && d.VBAT_PRESENT_STAT == 1) {
        ...
        // 5. صورتی
        else if (!(d.VSYS_OVP_STAT == 1 || d.VBAT_OVP_STAT == 1 || d.TSHUT_STAT == 1 || d.OTG_OVP_STAT == 1 || d.OTG_UVP_STAT == 1 || (d.EN_OTG == 1 && (d.TS_COLD_STAT == 1 || d.TS_HOT_STAT == 1)) || d.EN_HIZ == 1 || d.SDRV_CTRL != 0 || d.VSYS_SHORT_STAT == 1) && ((d.VBUS_OVP_STAT == 0 && d.VSYS_OVP_STAT == 0 && d.VBAT_OVP_STAT == 0) || ((d.AC1_PRESENT_STAT == 1 && d.AC2_PRESENT_STAT == 1) && d.VBAT_PRESENT_STAT == 1 && ((d.VSYS_ADC_15_0 - d.VBAT_ADC_15_0 - 50 > 0) || ((d.VINDPM_STAT == 1 || d.IINDPM_STAT == 1 || d.IBAT_REG_STAT == 1 || d.TREG_STAT == 1) && d.VSYS_ADC_15_0 - d.VBAT_ADC_15_0 - 50 <= 0)))) && d.VBAT_PRESENT_STAT == 1 && d.VBATOTG_LOW_STAT == 0 && d.TS_COLD_STAT == 0 && d.TS_HOT_STAT == 0 && d.VBAT_OVP_STAT == 0 && d.IBAT_OCP_STAT == 0 && d.TSHUT_STAT == 0 && d.OTG_OVP_STAT == 0 && d.OTG_UVP_STAT == 0 && ((d.ACRB1_STAT == 1 || d.ACRB2_STAT == 1) && (d.EN_ACDRV1 == 0 && d.EN_ACDRV2 == 0)) && d.CHG_STAT_2_0 == 0 && d.SDRV_CTRL == 0) {
        ...
        // 7. زرد (برگشت)
        else if (!(d.VBUS_OVP_STAT == 1 || d.VSYS_OVP_STAT == 1 || d.VBAT_OVP_STAT == 1 || d.TSHUT_STAT == 1 || d.OTG_OVP_STAT == 1 || d.OTG_UVP_STAT == 1 || (d.EN_OTG == 1 && (d.TS_COLD_STAT == 1 || d.TS_HOT_STAT == 1)) || d.EN_HIZ == 1 || d.SDRV_CTRL != 0 || d.VAC_OVP_STAT == 1 || d.VSYS_SHORT_STAT == 1) && d.VBAT_PRESENT_STAT == 1 && ((d.EN_OTG == 1 && d.TS_COLD_STAT == 0 && d.TSHUT_STAT == 0 && d.OTG_OVP_STAT == 0 && d.OTG_UVP_STAT == 0 && (d.IINDPM_STAT == 1 || d.IBAT_REG_STAT == 1 || d.TREG_STAT == 1) && d.CHG_STAT_2_0 == 0) || (d.VBUS_PRESENT_STAT == 1 && d.PG_STAT == 1 && d.EN_OTG == 0 && d.TS_COLD_STAT == 0 && ((d.VINDPM_STAT == 1 || d.IINDPM_STAT == 1 || d.IBAT_REG_STAT == 1 || d.TREG_STAT == 1) && ((d.IBAT_ADC_15_0 <= 0) || (d.VSYS_ADC_15_0 <= d.VBAT_ADC_15_0))))) && d.TS_HOT_STAT == 0 && d.VBATOTG_LOW_STAT == 0 && d.VBAT_OVP_STAT == 0 && d.IBAT_OCP_STAT == 0 && ((d.ACRB1_STAT == 0 && d.ACRB2_STAT == 0) || (d.EN_ACDRV1 == 1 || d.EN_ACDRV2 == 1)) && d.SDRV_CTRL == 0) {
            if (d.EN_OTG == 1) {
        ...
        // 8. آبی (برگشت)
        else if (!(d.VBUS_OVP_STAT == 1 || d.VSYS_OVP_STAT == 1 || d.VBAT_OVP_STAT == 1 || d.TSHUT_STAT == 1 || d.OTG_OVP_STAT == 1 || d.OTG_UVP_STAT == 1 || (d.EN_OTG == 1 && (d.TS_COLD_STAT == 1 || d.TS_HOT_STAT == 1)) || d.EN_HIZ == 1 || d.SDRV_CTRL != 0 || d.VAC_OVP_STAT == 1 || d.VSYS_SHORT_STAT == 1) && d.EN_OTG == 1 && d.VBAT_PRESENT_STAT == 1 && d.VBUS_PRESENT_STAT == 1 && d.VBATOTG_LOW_STAT == 0 && d.TS_COLD_STAT == 0 && d.TS_HOT_STAT == 0 && d.VBAT_OVP_STAT == 0 && d.IBAT_OCP_STAT == 0 && d.TSHUT_STAT == 0 && d.OTG_OVP_STAT == 0 && d.OTG_UVP_STAT == 0 && d.VBUS_STAT_3_0 == 7 && ((d.ACRB1_STAT == 0 && d.ACRB2_STAT == 0) || (d.EN_ACDRV1 == 1 || d.EN_ACDRV2 == 1)) && d.IINDPM_STAT == 0 && d.IBAT_REG_STAT == 0 && d.TREG_STAT == 0 && d.CHG_STAT_2_0 == 0 && d.SDRV_CTRL == 0) {
