...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const registerConfig = {
        ...
        // --- MASK Registers (Logic: 0=Unmasked/INT On, 1=Masked/INT Off) ---
        IINDPM_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        VINDPM_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        WD_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        POORSRC_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        PG_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        AC2_PRESENT_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        AC1_PRESENT_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        VBUS_PRESENT_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        CHG_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        ICO_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        VBUS_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        TREG_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        VBAT_PRESENT_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        BC1_2_DONE_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        DPDM_DONE_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        ADC_DONE_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        VSYS_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        CHG_TMR_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        TRICHG_TMR_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        PRECHG_TMR_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        TOPOFF_TMR_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        VBATOTG_LOW_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        TS_COLD_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        TS_COOL_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        TS_WARM_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        TS_HOT_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        IBAT_REG_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        VBUS_OVP_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        VBAT_OVP_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        IBUS_OCP_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        IBAT_OCP_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        CONV_OCP_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        VAC2_OVP_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        VAC1_OVP_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        VSYS_SHORT_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        VSYS_OVP_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        OTG_OVP_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        OTG_UVP_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } },
        TSHUT_MASK: { type: 'boolean', options: { '0': 'Unmasked', '1': 'Masked' } }
    };
